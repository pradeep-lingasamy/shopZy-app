    ...
    return(
        <div className='aboutcontainer'>
            ...
            <div className='aboutcontent'>
                <div>
                    <p><h1>Our story</h1>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                    ...
                    <div className='imgcontainer'><div><img src={story}/></div></div>
                </div>  
                <div>
                    <div className='imgcontainer missionimg'><div><img src={mission}/></div></div>
                    <p>
                    <p><h1>Our Mission</h1>Mauris non lacinia magna. Sed nec lobortis dolor. 
                    ...
                    <div className='imgcontainer belowimg'><div><img src={mission}/></div></div>
                </div>   
            </div>
            <Footer />
        </div>
